...
# need to lazy load because it prevent aliases or env in this file to load properly
# zinit ice wait"1"
...
alias toggle-keyboard="~/script/toggle-keyboard.sh"
alias toggle-touchpad-keyboard="~/script/toggle-touchpad-keyboard.sh"
...
# zprof | less
#
# alias rust-analyzer="eval $(rustup which rust-analyzer)"
